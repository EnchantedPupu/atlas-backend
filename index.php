...
if (isset($_POST['login'])) {
    ...
    if ($username && $password) {
        try {
            ...
            $stmt = $db->prepare("SELECT user_id, name, role, username, password, profile_picture FROM User WHERE username = ?");
...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <h1>ATLAS</h1>
            <p>User Portal - Please login to continue</p>
        </div>
        ...
        <div>
            <p>Powered by <img src="assets/images/accurate.png" alt="ACCURATE Logo" class="logo"></p>
        </div>
    </div>
</body>
</html>
